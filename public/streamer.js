...
// Create div to say video is live
...
const addLocalVideo = async () => {
    // Add video track from camera/webcam
...
const endStream = async () => {
    //If streaming, call /end endpoint to end the stream
    if (streaming) {
        try {
...
const startOrEndStream = async (event) => {
    // called when the startEndButton is clicked
    // If there is no livestream ongoing, this function will call startStream()
    // if a stream is in progress, the function will call endStream() to stop it
